...
public record AluguelRequesstDTO(@NotNull(message = "O campo (pessoa_id) não pode ser nulo") Long pessoa_id,
                                 ...
                                 @NotBlank(message = "O campo (data_inicio) não pode ser nulo") LocalDate data_inicio,
                                 @NotBlank(message = "O campo (data_final) não pode ser nulo") LocalDate data_final
                                 ) {
}
